...
def snake_vision(my_head: Dict[str, int], board: Dict[str, int]) -> List[str]:
    """
...
def sv_avoid_walls(vision: List[str], possible_moves: List[str]) -> List[str]:
  if vision == ["X", "X", "X", "S", "H", "S", "S", "S", "S"]:
    print("Detected bottom wall")
    remove_move("down", possible_moves)
  elif vision == ["S", "S", "S", "S", "H", "S","X", "X", "X"]:
    print("Detected top wall")
    remove_move("up", possible_moves)
  elif vision == ["X", "S", "S", "X", "H", "S","X", "S", "S"]:
    print("Detected left wall")
    remove_move("left", possible_moves)
  elif vision == ["S", "S", "X", "S", "H", "X","S", "S", "X"]:
    print("Detected right wall")
    remove_move("right", possible_moves)
  elif vision == ["X", "X", "X", "X", "H", "S","X", "S", "S"]:
    print("Detected bottom left corner")
    remove_move("down", possible_moves)
    remove_move("left", possible_moves)
  elif vision == ["X", "X", "X", "S", "H", "X","S", "S", "X"]:
    print("Detected bottom right corner")
    remove_move("down", possible_moves)
    remove_move("right", possible_moves)
  elif vision == ["X", "S", "S", "X", "H", "S","X", "X", "X"]:
    print("Detected top left corner")
    remove_move("up", possible_moves)
    remove_move("left", possible_moves)
  elif vision == ["S", "S", "X", "S", "H", "X","X", "X", "X"]:
    print("Detected top right corner")
    remove_move("up", possible_moves)
    remove_move("right", possible_moves)
...
def choose_move(data: dict) -> str:
    ...
    #my_vision = snake_vision(my_head, data["board"])
    ...
    #possible_moves = sv_avoid_walls(my_vision, possible_moves)
